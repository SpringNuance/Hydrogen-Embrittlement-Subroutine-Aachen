...
subroutine UMATHT(u,dudt,dudg,flux,dfdt,dfdg, &
    ...
    C0_mol = props(18)  ! Initial hydrogen concentration (mol/m^3)
    mu0 = props(19)  ! Initial chemical potential (N*m/mol)
    ntrap = props(20)  ! Number of trap types (0 - no traps, 1 - dislocation, 2 - 5 for additional trap types)
                    ! You can have as many traps as you want by defining alpha, NT and WB at the end of the UMATHT props
    equilibrium_equation = props(21)  ! (1 - Oriani's equation | 2 - McNabb-Foster’s equation)
    ...
    statev(dCT_dCL_idx) = dCT_mol_dCL_mol
    statev(dCT_deqplas_idx) = dCT_mol_deqplas
return
end
