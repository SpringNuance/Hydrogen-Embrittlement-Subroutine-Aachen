...
module userinputs
    ...
    integer, parameter :: dCT_dCL_idx = 36 ! Index of the derivative of trap concentration with respect to lattice concentration in statev
    integer, parameter :: dCT_deqplas_idx = 37 ! Index of the derivative of trap concentration with respect to equivalent plastic strain in statev
