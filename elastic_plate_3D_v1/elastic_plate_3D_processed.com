...
options = {
    ...
    'importer':OFF,
    'importerParts':OFF,
    'includes':['processing_input/nodes.inc', 'processing_input/elements.inc'],
    'inertiarelief':OFF,
    'initialConditionsFile':OFF,
    'input':'elastic_plate_3D_processed',
    'inputFormat':INP,
    'interactive':None,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':False,
    'job':'elastic_plate_3D_processed',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'unfold_param':OFF,
    'unsymm':OFF,
    'user':'source_code/AACHEN_HYDROGEN.f90',
    'verbose':1,
    'visco':OFF,
    'xplSelect':OFF,
}
