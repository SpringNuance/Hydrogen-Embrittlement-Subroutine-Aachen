...
# Run by nguyenb5 on Tue Sep  3 14:14:55 2024
#
...
#: Model: C:/LocalUserData/User-data/nguyenb5/hydrogen_diffusion_BC/CP1000_steel_trap/krom_kumnick/CP1000_diffusion_post.odb
...
session.viewports['Viewport: 1'].view.setValues(nearPlane=0.0253714, 
    farPlane=0.042799, width=0.0189527, height=0.00994488, 
    viewOffsetX=2.73453e-05, viewOffsetY=-0.000991622)
odbName=session.viewports[session.currentViewportName].odbDisplay.name
session.odbData[odbName].setValues(activeFrames=(('Step-1', (8, )), ))
odb = session.odbs['C:/LocalUserData/User-data/nguyenb5/hydrogen_diffusion_BC/CP1000_steel_trap/krom_kumnick/CP1000_diffusion_post.odb']
...
session.writeXYReport(fileName='results_2_mins.txt', appendMode=OFF, xyData=(
...
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=480 )
session.viewports['Viewport: 1'].odbDisplay.setFrame(step=0, frame=480 )
session.odbs['C:/LocalUserData/User-data/nguyenb5/hydrogen_diffusion_BC/CP1000_steel_trap/krom_kumnick/CP1000_diffusion_post.odb'].close(
    )
o1 = session.openOdb(
    name='C:/LocalUserData/User-data/nguyenb5/hydrogen_diffusion_BC/CP1000_steel_trap/krom_kumnick/CP1000_diffusion_post.odb')
...
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='SDV_AR4_CL_MOL', outputPosition=INTEGRATION_POINT, )
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='SDV_AR5_CT_MOL', outputPosition=INTEGRATION_POINT, )
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='SDV_AR6_CT_DIS_MOL', outputPosition=INTEGRATION_POINT, )
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='SDV_AR10_THETAL', outputPosition=INTEGRATION_POINT, )
session.viewports['Viewport: 1'].odbDisplay.setPrimaryVariable(
    variableLabel='SDV_AR11_THETAT_DIS', outputPosition=INTEGRATION_POINT, )
session.viewports['Viewport: 1'].view.setValues(nearPlane=0.0252511, 
    farPlane=0.0429193, width=0.0211619, height=0.0111041, 
    viewOffsetX=-0.00055981, viewOffsetY=-0.00109)
xyp = session.XYPlot('XYPlot-1')
chartName = xyp.charts.keys()[0]
chart = xyp.charts[chartName]
xy1 = session.xyDataObjects['AVERAGE_SDV_AR7_CT_GB_MOL']
